...
const Hero = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-stone-950 via-zinc-900 to-zinc-950 min-h-screen lg:min-h-fit pt-6 lg:pt-8 lg:pb-14 snap-y snap-mandatory scroll-smooth overflow-y-auto lg:overflow-visible">
      <div className="mx-auto max-w-7xl lg:px-8 overflow-hidden sm:overflow-visible">
        <div className="lg:grid lg:grid-cols-2 lg:gap-8">
          {/* Hero Text Section */}
          <div className="snap-start mx-auto max-w-md px-6 h-[90vh] lg:h-auto flex flex-col justify-center sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left z-10">
          ...
          {/* Video Cards Section */}
          <div className="mt-56 -mb-16 sm:-mb-48 lg:relative lg:m-0 snap-start">
